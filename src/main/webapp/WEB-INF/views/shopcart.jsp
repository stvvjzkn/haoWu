...
<%--                                        <tr>--%>
<%--                                            <td class="product-remove product-remove_2">--%>
<%--                                                <a class="delete-goods" data-goodsid="78"><img--%>
<%--                                                        src="${pageContext.request.contextPath}/image/delete.png"></a>--%>
<%--                                            </td>--%>
...
<%--                                                        &lt;%&ndash;   <span>${goods.num}</span>&ndash;%&gt;--%>
...
<%--                                                &lt;%&ndash;<c:set value="${oldTotalPrice+goods.price*goods.num*goods.activity.discount}" var="oldTotalPrice"/>&ndash;%&gt;--%>
<%--                                        </tr>--%>
<%--                                    </c:forEach>--%>
