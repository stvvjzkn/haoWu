...
<%--                                            //error:图片异常不显示--%>
                                            <img src="${pageContext.request.contextPath}/shopimage/${goods.imagePaths[0].path}" alt="" width="200" height="200"/>
<%--                                            <img src="/shopimage/5.jpg" alt="">--%>
                                        </a>
                                    </div>
                                    <p class="text-right">
                                ...
                                <li class="data-item-li">
                                    <div class="to-big">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${colgoods.goodsid}">
                                            <img
                                                src="${pageContext.request.contextPath}/shopimage/${colgoods.imagePaths[0].path}" alt=""
                                                width="200" height="200">
                                        </a>
                                    </div>
                                    <p class="text-right">
                                ...
                                <li class="data-item-li">
                                    <div class="to-big">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${bookgoods.goodsid}"> <img
                                                src="${pageContext.request.contextPath}/shopimage/${bookgoods.imagePaths[0].path}" alt=""
                                                width="200" height="200">
                                        </a>
                                    </div>
                                    <p class="text-right">
